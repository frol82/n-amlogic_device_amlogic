...
$(call inherit-product, device/amlogic/p281/product/product.mk)
...
PRODUCT_AML_SECUREBOOT_USERKEY := ./uboot/board/amlogic/gxl_p281_v1/aml-user-key.sig
...
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/amlogic/p281/fstab.AB.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/p281/fstab.AB.amlogic:root/fstab.amlogic
endif
else
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/amlogic/p281/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/p281/fstab.amlogic:root/fstab.amlogic
endif
endif
else
ifeq ($(AB_OTA_UPDATER),true)
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/amlogic/p281/fstab.AB.verity.amlogic:recovery/root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/p281/fstab.AB.amlogic:recovery/root/fstab.amlogic
endif
else
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/amlogic/p281/fstab.verity.amlogic:recovery/root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/p281/fstab.amlogic:recovery/root/fstab.amlogic
endif
endif
endif
...
#
#################################################################################
#ifneq ($(TARGET_BUILD_GOOGLE_ATV), false)
#BUILD_WITH_PPPOE := false
#endif

#ifeq ($(BUILD_WITH_PPPOE),false)
#PRODUCT_PACKAGES += \
#    PPPoE \
#    libpppoejni \
#    libpppoe \
...
include device/amlogic/p281/proprietary/proprietary.mk 
