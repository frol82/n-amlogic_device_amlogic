...
PRODUCT_PACKAGES += \
	6212/nvram.txt    \
	6212/fw_bcm43438a1.bin \
	6212/fw_bcm43438a1_apsta.bin \
	6212/fw_bcm43438a1_p2p.bin \
	wl \
	p2p_supplicant_overlay.conf \
	dhd
...
################################################################################## ssv6051
ifeq ($(WIFI_MODULE), ssv6051)

WIFI_DRIVER := ssv6051
BOARD_WIFI_VENDOR       := icomm
WIFI_DRIVER_MODULE_PATH := /system/lib/ssv6051.ko
WIFI_DRIVER_MODULE_NAME := ssv6051
WIFI_DRIVER_MODULE_ARG  := "stacfgpath=/system/etc/wifi/ssv6051/ssv6051-wifi.cfg"
...
PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.wifi.direct.xml:system/etc/permissions/android.hardware.wifi.direct.xml
PRODUCT_COPY_FILES += hardware/amlogic/wifi/icomm/config/p2p_supplicant_overlay.conf:system/etc/wifi/p2p_supplicant_overlay.conf
PRODUCT_COPY_FILES += hardware/wifi/icomm/drivers/ssv6xxx/ssv6051/firmware/ssv6051-sw.bin:system/etc/wifi/ssv6051/ssv6051-sw.bin
PRODUCT_COPY_FILES += hardware/wifi/icomm/drivers/ssv6xxx/ssv6051/firmware/ssv6051-wifi.cfg:system/etc/wifi/ssv6051/ssv6051-wifi.cfg
...
PRODUCT_COPY_FILES += hardware/amlogic/wifi/mediatek/7668_firmware/wifi.cfg:system/etc/firmware/wifi.cfg
PRODUCT_COPY_FILES += hardware/amlogic/wifi/mediatek/7668_firmware/EEPROM_MT7668.bin:system/etc/firmware/EEPROM_MT7668.bin
PRODUCT_COPY_FILES += hardware/amlogic/wifi/mediatek/7668_firmware/cr4/WIFI_RAM_CODE2_SDIO_MT7668.bin:system/etc/firmware/WIFI_RAM_CODE2_SDIO_MT7668.bin
PRODUCT_COPY_FILES += hardware/amlogic/wifi/mediatek/7668_firmware/n9/WIFI_RAM_CODE_MT7668.bin:system/etc/firmware/WIFI_RAM_CODE_MT7668.bin
PRODUCT_COPY_FILES += hardware/amlogic/wifi/mediatek/7668_firmware/patch/mt7668_patch_e1_hdr.bin:system/etc/firmware/mt7668_patch_e1_hdr.bin
PRODUCT_COPY_FILES += hardware/amlogic/wifi/mediatek/7668_firmware/patch/mt7668_patch_e2_hdr.bin:system/etc/firmware/mt7668_patch_e2_hdr.bin
PRODUCT_COPY_FILES += hardware/wifi/icomm/drivers/ssv6xxx/ssv6051/firmware/ssv6051-sw.bin:system/etc/wifi/ssv6051/ssv6051-sw.bin
PRODUCT_COPY_FILES += hardware/wifi/icomm/drivers/ssv6xxx/ssv6051/firmware/ssv6051-wifi.cfg:system/etc/wifi/ssv6051/ssv6051-wifi.cfg
PRODUCT_COPY_FILES += \
    hardware/amlogic/wifi/qcom/config/qca9377/wifi/bdwlan30.bin:system/etc/wifi/qca9377/bdwlan30.bin \
    hardware/amlogic/wifi/qcom/config/qca9377/wifi/otp30.bin:system/etc/wifi/qca9377/otp30.bin \
    hardware/amlogic/wifi/qcom/config/qca9377/wifi/qwlan30.bin:system/etc/wifi/qca9377/qwlan30.bin \
    hardware/amlogic/wifi/qcom/config/qca9377/wifi/utf30.bin:system/etc/wifi/qca9377/utf30.bin \
    hardware/amlogic/wifi/qcom/config/qca9377/wifi/wlan/cfg.dat:system/etc/wifi/qca9377/wlan/cfg.dat \
    hardware/amlogic/wifi/qcom/config/qca9377/wifi/wlan/qcom_cfg.ini:system/etc/wifi/qca9377/wlan/qcom_cfg.ini \
    hardware/amlogic/wifi/qcom/config/qca9377/wifi/wlan/qcom_wlan_nv.bin:system/etc/wifi/qca9377/wlan/qcom_wlan_nv.bin \
